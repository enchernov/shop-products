...
import { Accordion, Button, Input } from '@ui/index'
import { useFormik } from 'formik'
import * as yup from 'yup'
import { makeTicket, unsubscribeEmail } from '@utils/account'
    ...
    <Grid container direction={'column'} spacing={6} className={classes.root}>
      ...
      <Grid item xs={12}>
        <Grid container justify={'space-between'} alignItems={'center'}>
          <Grid item className={classes.contactContanier} xs={3}>
              ...
              <Grid item>
                <Accordion title={'Доставляет ли FoodMarket в моём городе?'}>
                  <Typography variant={'body2'}>
                    ...
                    зарегистрируйтесь у нас, а затем посетите домашнюю страницу
                    продуктового магазина и закажите доставку. Если мы не сможем
