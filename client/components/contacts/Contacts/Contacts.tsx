            ...
            <Grid item xs={isSmallWidth ? 12 : 6}>
              ...
              <Grid container spacing={1}>
                <Grid item>
                  <Accordion title={'Доставляет ли FoodMarket в моём городе?'}>
                    <Typography variant={'body2'}>
                      ...
                      зарегистрируйтесь у нас, а затем посетите раздел "Магазин"
                      FoodMarket и закажите доставку. Если мы не сможем
                      доставить товар по вашему адресу,мы объясним, почему.
                    </Typography>
                  </Accordion>
                </Grid>
                <Grid item>
                  <Accordion title={'В какое время будет доставлен заказ?'}>
                    <Typography variant={'body2'}>
                      Благодаря курьерам FoodMarket, ваш заказ будет доставлен в
                      ближайшее время: от нескольких часов до суток. Стоит
                      ожидать прибытия курьера с 07:00 до 00:00 по местному
                      времени.
                    </Typography>
                  </Accordion>
                </Grid>
                <Grid item>
                  ...
                  >
                    <Typography variant={'body2'}>
                      Политика FoodMarket такова, что онлайн-покупатели равны
                      людям, покупающими продукты в офлайн-магазинах. Поэтому
                      ценообразование происходит одинаково для розничных точек и
                      интернет-магазина. Стоит отметить особые акции для
                      онлайн-покупателей, благодаря которым покупка в сети будет
                      выгоднее похода в обычный магазин.
                    </Typography>
                  </Accordion>
                </Grid>
                <Grid item>
                  ...
                  >
                    <Typography variant={'body2'}>
                      FoodMarket принимает к оплате любые кредитные и дебетовые
                      карты, в частности Visa и Mastercard.
                    </Typography>
                  </Accordion>
                </Grid>
                <Grid item>
                  <Accordion title={'Какова политика возврата товаров?'}>
                    <Typography variant={'body2'}>
                      Если вы не удовлетворены продуктом, FoodMarket осуществит
                      возврат в течение нескольких часов. Курьер заберёт ваш
                      заказ, а средства будут возвращены на карту, с которой
